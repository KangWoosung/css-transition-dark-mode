...
Rainy Glass Effect using rainyday.js library
        ...
        >
          ...
          >
            *Note: RainyDayJSContainer uses the classic rainyday.js library
            ...
            <br />
            <br />
            Keep the cons in your mind and use the one you like.
            <br />
          </p>
...
<RainyDayJSContainer
  ...
  {children}
          ...
          <Button
            variant="outline"
            className={rainyDayOn ? "rounded-full bg-purple-800 text-white" : "rounded-full"}
            onClick={() => {
              console.log("clicked");
          ...
          <Button
            variant="outline"
            className={rainDropFXOn ? "rounded-full bg-purple-800 text-white" : "rounded-full"}
            onClick={() => {
              console.log("clicked");
        ...
        <div
          ...
          h-[500px] sm:h-[600px]"
        >
          <div className="w-full h-full flex-[2] min-w-0 border-2 border-green-500 overflow-hidden">
              <RainyDayJSContainer
              backgroundImage="url(/assets/img/logo.jpg)"
              options={{
                defaultRainDropSize: 3,
              ...
              >
                <div className="relative z-10 h-full flex flex-col items-center justify-center text-white">
                  ...
                  <p className="text-xl drop-shadow-md">
                    Beautiful rain effect on glass
                  </p>
                </div>
              </RainyDayJSContainer>
          </div>

          <div className="w-full h-full flex-[2] min-w-0 border-2 border-yellow-500 overflow-hidden">
              ...
              <RainDropFXContainer backgroundImage="/assets/img/logo.jpg">
                ...
                flex flex-col items-center justify-center text-white">
                  ...
                  <p className="text-l drop-shadow-md">
                    Important!! This component does not work when remounted!!
                  </p>
                  <p className="text-l drop-shadow-md">
                    This Library use WebGL & Canvas.
                    <br />
                    The Canvas must be only one and unique. <br />
                  </p>
                  <p className="text-l warning-text bg-red-400 p-2 rounded-md">
                    This component will not work when remounted.<br />

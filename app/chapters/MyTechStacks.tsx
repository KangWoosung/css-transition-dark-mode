  ...
  return (
	...
	<TechIcons name="expo" invert={true}  />
          ...
          <button
            ...
            className="flex h-12 w-full items-center justify-center rounded-full px-5
          border border-solid border-black/[.2] hover:border-transparent
          transition-colors
          bg-white/[.05] dark:bg-black/[0.5] hover:dark:bg-white/[.1] hover:bg-black/[.1]
          dark:border-white/[.3]
          md:w-[158px]"
          >
            Show Stack Icons
